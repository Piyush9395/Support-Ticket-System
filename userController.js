...
const registerUser = async (req, res) => {
    try {
        const { fullName, email, password, confirmPassword, telephone } = req.body;
        ...
        // Insert new user
        const insertUserQuery = 'INSERT INTO users (fullName, email, password_hash, telephone) VALUES (?, ?, ?, ?)';
        await db.query(insertUserQuery, [fullName, email, hashedPassword, telephone]);
